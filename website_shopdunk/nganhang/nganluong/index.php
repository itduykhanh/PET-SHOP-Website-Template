...
<h3 style="text-align: center">Chọn phương thức thanh toán</h3>
<form  name="NLpayBank" action="#" method="post">
    <table style="margin: auto;width:500px;padding-left:46px;">
        ...
        <tr><td>Số tiền thanh toán: </td>
            <td>
                <input type="text" style="width:270px" id="total_amount" name="total_amount" class="field-check " value="<?php echo $_SESSION["order"]['price_total']; ?>">
            </td>
        </tr>
        <tr><td>Họ Tên: </td>
            <td>
                <input type="text" style="width:270px" id="fullname" name="buyer_fullname" class="field-check " value="<?php echo $_SESSION["order"]['fullname'];?>">
            </td>
        </tr>
        <tr><td>Email: </td>
            <td>
                <input type="text" style="width:270px" id="fullname" name="buyer_email" class="field-check " value="<?php echo $_SESSION["order"]['email'];?>">
            </td>
        </tr>
        <tr><td>Số Điện thoại: </td>
            <td>
                <input type="text" style="width:270px" id="fullname" name="buyer_mobile" class="field-check " value="<?php echo $_SESSION["order"]['mobile'];?>">
            </td>
        </tr>
    </table>
    <ul class="list-content" style="margin: auto;width: 500px;">
    ...
    <table style="margin: auto;width:500px;padding-left:20px;">
        <tr>
            <td>
                <input type="submit" style="background-color: #f36f21;border: 1px solid #f36f21;padding: 10px;border-radius: 3px;color: white" name="nlpayment" value="Thanh Toán Đơn Hàng"/>
            </td>
        </tr>
    </table>
</form>
