...
<!--                  -->
                  ...
                  <div class="form-group">
                    ...
                    <input type="date" name="product_year" value="<?php echo isset($product['product_year']) ? $product['product_year'] : $_POST['product_year'] ?>" class="form-control" id="product_year">
                  </div>
                  <div class="form-group">
                    <label for="capacity">Dung lượng sản phẩm :</label>
                    <input type="number" name="capacity" value="<?php echo isset($product['capacity'])  ? $product['capacity'] :  '' ?>" class="form-control" id="capacity">
                  </div>
                  <div class="form-group">
                    <label for="ram">Ram :</label>
                    <input type="number" name="ram" value="<?php echo isset($product['ram']) ? $product['ram'] :  ''?>" class="form-control" id="ram">
                  </div>
                    <div class="form-group">
