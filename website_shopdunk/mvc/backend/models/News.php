...
// thêm danh mục sản phẩm
    public function insert(){
        $sql_insert="Insert into news(`name`,`avatar`,`content`,`status`,`summary`,`hotnews`)
        VALUES (:name,:avatar,:content,:status,:summary,:hotnews)";
...
//    chi tiết của danh mục
    public function getNewsById($id){
        $select_one="select * from news where news.id=$id";
...
//    chỉnh sửa danh mục
    public function update($id){
        $sql_update="Update news set `name`=:name,`status`=:status,`avatar`=:avatar,`summary`=:summary,`content`=:content,
